...
echo "   • Users for all 10 roles (Executives, Managers, Staff)"
...
if [[ "$seed_demo" == "y" || "$seed_demo" == "Y" ]]; then
  ...
  if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "🔐 Demo User Credentials (See full list in terminal output above)"
    echo "   Key Accounts:"
    echo "   • Admin: admin@bangopoints.com / Admin@123"
    echo "   • CEO: ceo@bangopoints.com / Demo@123"
    echo "   • Brand Manager: brandmanager@bangopoints.com / Demo@123"
